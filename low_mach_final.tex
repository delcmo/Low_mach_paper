...
variations in space and time. When using the SGEOS, the coefficient of proportionality $\frac{s_e}{P_e}$ can be recast under the form $\frac{s_e}{P_e} = \frac{C_v ( \gamma-1)}{P + \gamma P_\infty}$ which remains positive. Thus, one may elect to employ $\resinew$ instead of $\resi$ for the evaluation 
...
\end{subequations}
%
Note that now the jump operator $J^K$ acts on the variables appearing in $\resinew$, namely, pressure and density. 
...
%
\begin{remark}\label{rm:ill-scaled}
When using the definition of the first-order viscosity coefficient $\mu_{max}$, it can be shown that the Reynolds and P\'eclet numbers scale as the inverse of the Mach number leading to ill-scaled dissipative terms in the low-Mach limit. This behavior is undesirable but in the shock region where the second-order viscosity coefficient saturates to the first-order viscosity coefficient.
\end{remark}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%s%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
illustration of the effect of ill-scaled dissipative terms in the low-Mach limit that was pointed out in \rmk{rm:ill-scaled}.
%
...
\begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.495\textwidth}
                \centering
                \includegraphics[width=\textwidth]{vapor_mach_numerical_and_exact_500.png}
                \caption{Mach number}
                \label{fig:1d_nozzle_vap_vel}
        \end{subfigure}%
        \begin{subfigure}[b]{0.495\textwidth}
                \centering
                \includegraphics[width=\textwidth]{vapor_density_numerical_and_exact_500.png}
                \caption{Density}
        ...
        \begin{subfigure}[b]{0.495\textwidth}
                \centering
                \includegraphics[width=\textwidth]{vapor_pressure_numerical_and_exact_500.png}
                \caption{Pressure}
                \label{fig:1d_nozzle_vap_press}
        \end{subfigure}
        \begin{subfigure}[b]{0.495\textwidth}
                \centering
                \includegraphics[width=\textwidth]{vapor_viscosity_numerical_500.png}
                \caption{Viscosity coefficients}
...
\item The steady-state pressure fluctuations are proportional to the square of inlet Mach number, i.e., 
\begin{equation}
...
\end{equation}
where $\delta P$ and $M_\infty$ denote the steady-state pressure fluctuations and the inlet Mach number, respectively.
\end{itemize}
%
...
\caption{Log-log plot of the steady-state pressure and velocity fluctuations as a function of the far-field Mach number.}
