...
In many engineering applications, compressibility effects require the the solution of the compressible fluid equations
...
Many well-known stabilization techniques, for instance, the Roe scheme and the SUPG technique \cite{},
...
can be obtained effective while preserving the accuracy of the transient solution; however, it requires the use of nonlinear solvers.
...
A new version of the entropy viscosity method valid for a wide range of Mach numbers has been derived 
and presented for the inviscid Euler equations.
% in multi-dimensions and the 1-D Euler equations with variable area. 
...
for the entropy function, and is therefore applicable to a larger set of problems. 
