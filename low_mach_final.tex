...
transonic \tcr{two times elsewhere that problem was described as supersonic but here you use transonic. which is it?} flow over a compression corner are provided to illustrate the ability of the new viscosity 
...
isentropic\tcr{should we take isentropic here? maybe}. A convergence study was performed using the exact solution as a reference: the L$_1$ and L$_2$ norms of the 
