...
depends on the local entropy production; their viscous regularization method is constructed to satisfy the entropy minimum principle. 
...
are added to all of the governing laws while ensuring the entropy minimum principle still holds. 
