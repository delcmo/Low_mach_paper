...
and correctly resolve the discontinuities \cite{lax-peter, harten-hyman}. A wide range of stabilization methods are available in the literature: approximate Riemann solvers \cite{Toro}, flux-limiter techniques 
...
and the entropy-viscosity method \cite{jlg1, jlg2}, flux-corrected transport \cite{fct-zalesak, fct-kuzmin-lohner}, among others. These numerical methods are usually developed using simple equations 
...
of the entropy residual, whose derivation is given in \app{app:ent_res}, is the following: %in \eqt{eq:ent_res}. The derivation that leads to this equation is provided in \app{app:ent_res}. 
%
\begin{equation}
\label{eq:ent_res}
