...
aforementioned 1-D test cases are given in \tbl{tbl:ic_1d_tests}.
\begin{table}[!htbp]
\begin{center}
...
\end{tabular}
\end{center}
\caption{\label{tbl:ic_1d_tests} Initial conditions for the 1-D test cases (density in $kg.m^{-3}$, velocity in $m.s^{-1}$, pressure in $Pa$).}
\end{table} 
