...
oscillations can occur with high order spatial discretization schemes due to shocks, discontinuities, or sharp changes in the solution.
Adequate numerical techniques are required to stabilize the numerical solution
and correctly resolve discontinuities \cite{lax-peter, harten-hyman} \tcr{should these reference stay here or go with the previous sentence?}.
%
...
Guermond et al. \cite{jlg1, jlg2} have developed the entropy viscosity method, a residual-based artificial viscosity method where the viscosity coefficient 
