...
Compressible fluid equations in the low-Mach limit is an ongoing topic of research. 
...
parameters $\norm_P$ are thus in units of pressure, hence the use of the subscript $P$.  It is emphasized that we are not requiring the same normalization for both $\mu_e$ and $\kappa_e$ so the entropy viscosity 
