...
low-Mach as was suggested during your defense. If I recall correctly, we said } \tcb{done}
...
%
%\tcr{I have removed your portion about the total residual falling below $10^{-6}$: 
...
%\tcr{am I tired or should this be concave?} \tcb{done} \tcr{Ok. It's likely still wrong in the dissertation files. You can delete these comments after you read this.} 
and given by
%
\begin{equation*}
