...
supersonic \tcr{you had transonic here but I think this problem is 100\% supersonic} flow over a compression corner are provided to illustrate the ability of the new viscosity 
...
in this case we still need to define it. I decided to say something simpler, rate of chage, that means $\frac{u^{n+1}-u^n}{\Delta t}$
but this may be wrong as well. It depends on how the steady-state residual are defined. Are they multiplied by $\Delta t$ or not. Please advise\\}
