...
We added the two above references to the introduction. % in line 17. 
...
%From potential flow theory, we know the exact value of the velocity at the top of the cylinder for the flow around a 
...
%
%The ``flow over a hump'' test case is often used in the literature to assess the symmetry of the steady-state solution when plotting the iso-Mach line 
%for low-Mach flows. This is also commonly used for other test such as the NACA wing in Ref. 20.
