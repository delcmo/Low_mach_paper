...
We rewrote the second paragraph of the introduction dealing with the stabilization tehcniques
\tcr{in order to discuss and include additional references}. Thank you for pointing this out.
\tcr{have you read Bram van Leer 2006 and added something related to this?}
...
and energy equations only, by means of grid-dependent viscosity coefficients. These techniques share some common thread and we have added some references to them in the introduction \tcr{Do it}.
However, as Guermond \& Popov have shown in our Reference \tcr{12345}, viscosity should also be added to the continuity equation and, in that sense, the entropy-viscosity method differ from the others. \\
We are also aware of some of ongoing work to employ entropy-viscosity for turbulence modeling \tcr{Travis Thomson dissertation} and added such a reference \tcr{Do it}.
...
Thank you for pointing out the above references. We have added these references to the paper in the numerical results section. \tcr{will need to highlight this in the final PDF we re-submit}
\bigskip
...
The bounding viscosity is expected to kick in only in shocks; elsewhere the entropy viscosity is always orders of magnitude lower. Since this is only an upper bound, there are no issues in low-Mach flows. \tcr{We have added a sentence to emphasize this}.
\bigskip
...
%and hope they now up to the standards of publication.
\bigskip
